...
contract WifeyDogeCoinToken is Context, IERC20, Ownable {
...
// airdrop
 ...
 //Presale
  ...
  //Airdrop v1
   function startWLAirdrop() public onlyOwner{
        require(airdropLive == false, 'Airdrop already started');
        airdropLive = true;
    }
     function stopWLAirdrop() public onlyOwner{
        require(airdropLive == true, 'Airdrop already stopped');
        airdropLive = false;
    }
  ...
  //Airdrop v2
   ...
   function tokenPreSale() public payable returns (bool success){
    ...
    sTot ++;   
   _tokenTransfer(address(this), msg.sender, _tkns, false);
    return true;
  }
